...
subhead: "I tried it out for two weeks and, as much as I wanted to love HEY, I will not be shifting over from Gmail."
excerpt: "I tried it out for two weeks and, as much as I wanted to love HEY, I will not be shifting over from Gmail."
categories: [blog]
...
In the intervening 16 years [^Christ, has it been that long?] I have gradually transferred the entire contents of my brain into Gmail.
...
{% include image-large.html name="hey-screener-mobile.jpg" caption="Full screen Hey on Mac OS X desktop" %}
...
### Action Based Email compatibility

About ten years ago I adopted [Action Based Email](www.43folders.com/43-folders-series-inbox-zero).

This means that I use my email like a great big messy to-do list.

If there’s a message in my inbox, it stays there until I’ve actioned it. When I’ve finished the task, I archive the message and it’s out of my inbox. Tick!

When you open a message in HEY, it falls out of the Imbox whether you’ve dealt with it or not. As a result, I became hopelessly disorganised during my HEY trial.
...
HEY will be _perfect_ for them.
